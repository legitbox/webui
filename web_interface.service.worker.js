...
/** @type {string} */
const CACHE_VERSION = '1727691006|291585027';
/** @type {string} */
const CACHE_PREFIX = 'web_interface-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'web_interface.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["web_interface.html","web_interface.js","web_interface.offline.html","web_interface.icon.png","web_interface.apple-touch-icon.png","web_interface.worker.js","web_interface.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["web_interface.wasm","web_interface.pck"];
